      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">         
            <img src="${urlPublic}/img/slide1.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/img/slide2.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/img/slide3.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/img/slide4.jpg" alt="Slide" title="Some text" >
          </div>
        </div>
      ...
      <div class="container marketing">
		...
		<c:forEach items="${peliculas }" var="pelicula">
			<div class="col-xs-12 col-sm-6 col-md-3">
				<img class="img-rounded" src="${urlPublic}/img/${pelicula.imagen }" alt="Generic placeholder image" width="150" height="200">
				...
				<%--<p><a class="btn btn-sm btn-primary" href="detail/${pelicula._id }/${fechaBusqueda}" role="button">Consulta Horarios &raquo;</a></p>--%>
					<p><a class="btn btn-sm btn-primary" href="detail?id_movie=${pelicula.id }&fecha_movie=${fechaBusqueda}" role="button">Consulta Horarios &raquo;</a></p>		
			</div>
		</c:forEach>
