...
<html lang="en">
	...
	<body>
		...
		<div class="container theme-showcase" role="main">
			...
			<form:form class="form-horizontal" method="post" modelAttribute="horario" action="save">
				<div class="row">         
					<div class="col-sm-3">
						<div class="form-group">
							<label for="idPelicula" class="control-label">Pelicula</label>              
<%-- 							<form:select id="pelicula" path="peliculas" multiple="multiple" class="form-control" items="${peliculas}" itemValue="id" itemLabel="titulo"/>             --%>
